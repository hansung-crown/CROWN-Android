...
public class ViewKnownGroup extends AppCompatActivity {

    public static final String mKnownFILENAME = "myKnownProfile";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_known_group);
        context = this;

        mPref = getSharedPreferences(mKnownFILENAME, Context.MODE_PRIVATE);

        displayContacts();

        gridView = (GridView) findViewById(R.id.gridKnown);
